...
const SITE_SETTINGS_SEED = {
  ...
  navLinks: [
    ...
    { label: "Crop Residue", href: "/crop-residue-feed" },
...
const SITE_SETTINGS_LOCALIZED: Record<string, Record<string, unknown>> = {
  am: {
    ...
    navLinks: [
      ...
      { label: "የሰብል ቀሪት", href: "/crop-residue-feed" },
      { label: "አጋሮች", href: "/partners" },
      { label: "ማዕከለ ስዕላት", href: "/gallery" },
      { label: "ብሎጎች", href: "/blog" },
    ],
  ...
  om: {
    ...
    navLinks: [
      ...
      { label: "Hambaa Midhaanii", href: "/crop-residue-feed" },
      { label: "Michoota", href: "/partners" },
      { label: "Suuraalee", href: "/gallery" },
      { label: "Barreeffamoota", href: "/blog" },
    ],
